...
from UI_rec.PersonCarRecing import PersonCar_MainWindow

class LoginForm(QWidget):
    def __init__(self):
        super().__init__()
        self.text = "行人车辆检测与计数系统"
        ...
        self.bird_main = self.PersonCar_Main()

    class PersonCar_Main(PersonCar_MainWindow):
        pass
    ...
    def initUI(self):
        ...
        # 添加左侧logo
        logolb = QLabel(self)
        logopix = QPixmap("icons/personcar.png")
        logopix_scared = logopix.scaled(150, 130)
